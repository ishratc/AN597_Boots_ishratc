...
```{r}
ci_intercepts <- confint(intercepts, level = 0.95)  #ci for intercepts
ci_intercepts

ci_slopes <- confint(slopes, level = 0.95)  #ci for slopes
ci_slopes

ci_sample <- confint(sample_model[[i]], level = 0.95)  #ci for intercepts
ci_sample
